...
//
Route::get('contact', 'controller_client@contact');
...
Route::post('search','controller_client@search');
Route::get('under','controller_client@under');
Route::get('between','controller_client@between');
Route::get('over','controller_client@over');
// Admin route
// Đơn đặt phòng
...
Route::post('dkkh','controller_admin@dkkh');
Route::get('chart-line', 'controller_admin@chartLine');
Route::get('chart-line-ajax', 'controller_admin@chartLineAjax');
